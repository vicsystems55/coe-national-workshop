              ...
              <tr>
                <td class="sm-py-32 sm-px-24" style="font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; padding: 48px; text-align: center;" align="center">
                  <a href="https://1.envato.market/vuexy_admin">
                    <img src="images/log.png" width="155" alt="" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle;">
                  </a>
                </td>
              </tr>
              <tr>
                  ...
                  <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; background-color: rgba(255, 255, 255, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262; color: rgba(98, 98, 98, var(--text-opacity));" bgcolor="rgba(255, 255, 255, var(--bg-opacity))" align="left">
                        ...
                        <p style="font-weight: 700; font-size: 20px; margin-top: 0; --text-opacity: 1; color: #ff5850; color: rgba(255, 88, 80, var(--text-opacity));">Mr. Oswald</p>
...
<br>
                            <span style="font-weight: 600;">Surname: </span> <span> {{$data['surname']}}</span><br>
                            <span style="font-weight: 600;">First name: </span> <span> {{$data['fname']}}</span><br>
                            <span style="font-weight: 600;">Middlename: </span> <span> {{$data['middlename']}}</span><br>
                            <span style="font-weight: 600;">Phone: </span> <span> {{$data['phone']}}</span><br>
                            <span style="font-weight: 600;">Email: </span> <span> {{$data['email']}}</span><br>
                            <span style="font-weight: 600;">Institution Name: </span> <span> {{$data['institutionname']}}</span><br>
                            <span style="font-weight: 600;">Address: </span> <span> {{$data['address']}}</span><br>
                            <span style="font-weight: 600;">Current Position: </span> <span> {{$data['currentposition']}}</span><br>
                            <span style="font-weight: 600;">Gender: </span> <span> {{$data['gender']}}</span><br>
                            <span style="font-weight: 600;">Reservation Code: </span> <span> {{$data['reservation_code']}}</span><br>
